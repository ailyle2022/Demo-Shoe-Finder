...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '管理员', description: '昵称', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@example.com', description: '邮箱', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'newpassword123', description: '新密码', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(6),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '', description: '搜索关键词', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UserQueryDto.prototype, "keyword", void 0);
//# sourceMappingURL=user.entity.dto.js.map